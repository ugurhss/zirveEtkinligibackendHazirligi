                                    ...
                                    <table class="participant-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <!-- Mevcut td elementlerini şu şekilde güncelleyin: -->
<td class="mobile-hidden" data-label="E-Posta">{{ $participant->email }}</td>
<td class="mobile-hidden" data-label="Telefon">{{ $participant->phone }}</td>
<td class="mobile-hidden" data-label="Yaş">{{ $participant->age }}</td>
<td class="mobile-hidden" data-label="Cinsiyet">
...
<td class="mobile-hidden" data-label="Kayıt Tarihi">{{ $participant->created_at->format('d.m.Y H:i') }}</td>
<td class="mobile-hidden" data-label="IP Adresi">{{ $participant->ip_address }}</td>

...
@section('content')
   ...
   style="background-color: #4a8cff; color: white; padding: 3px 7px; border-radius: 3px; text-decoration: none; display: flex; align-items: center; gap: 3px; font-size: 13px;">
                                                            onmouseover="this.style.backgroundColor='#3a7cdf'"
                                                            onmouseout="this.style.backgroundColor='#4a8cff'"
                                                        >

...
.default-layout-navbar {
    background-color: #2c3e50 !important; /* İstediğiniz renk kodunu verebilirsiniz */
    transition: all 0.3s ease; /* Düzgün geçiş efekti için */
}

/* Navbar hover efekti */
.default-layout-navbar:hover {
    background-color: #1e10e1 !important; /* Hover rengi */
    box-shadow: 0 4px 8px rgba(52, 17, 230, 0.1); /* İsteğe bağlı gölge efekti */
}

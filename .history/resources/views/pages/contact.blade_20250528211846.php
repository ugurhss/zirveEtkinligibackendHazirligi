					...
					<div class="wrapper">
						<div class="row no-gutters">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="name">İsim&Soyad</label>
													<input type="text" class="form-control" name="name" id="name" placeholder=">İsim&Soyad">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
				        	...
				        	<div class="dbox w-100 d-flex align-items-center">
				        		...
				        		<div class="text pl-3">
					            <p> <a href="tel:/+90 532 060 82 61">+90 532 060 82 61</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-center">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-3">
					            <p> <a href="mailto:bilgi@bsiz.org">bilgi@bsiz.org</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-center">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-3">
					            <p><span>Website</span> <a href="http://bursabirlikvakfi.org">Bursa Birlik Vakfi</a></p>
					          </div>
				          </div>
			          </div>
							</div>

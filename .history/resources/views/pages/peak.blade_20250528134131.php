...
@section('content')
 <section class="hero-section">
        <div class="container">
            <!-- Başlık -->
            <h1 class="event-title">SÜRDÜRÜLEBİLİRLİK VE İNSAN ZİRVESİ</h1>
            <h2 class="event-subtitle">2025 | BURSA</h2>
            ...
            <div class="logo-container">
                <img src="path/to/logo.png" alt="SİZ 2025 Logo" class="footer-logo">
            </div>
        </div>
    </section>

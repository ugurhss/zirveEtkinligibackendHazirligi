...
<div id="zirveCarousel" class="zirve-carousel carousel slide" data-bs-ride="carousel">

  <!-- Göstergeler (Opsiyonel) -->
  <ol class="carousel-indicators zirve-carousel-indicators">
    <li data-bs-target="#zirveCarousel" data-bs-slide-to="0" class="active"></li>
    <li data-bs-target="#zirveCarousel" data-bs-slide-to="1"></li>
    <li data-bs-target="#zirveCarousel" data-bs-slide-to="2"></li>
  </ol>

  <!-- Görsel İçerik -->
  <div class="carousel-inner zirve-carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/slide1.jpg') }}" alt="İlk Slâyt">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/slide2.jpg') }}" alt="İkinci Slâyt">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/slide3.jpg') }}" alt="Üçüncü Slâyt">
    </div>
  </div>

  <!-- Sol Ok Kontrol -->
  <a class="carousel-control-prev zirve-carousel-control-prev" href="#zirveCarousel" role="button" data-bs-slide="prev">
    <span class="carousel-control-prev-icon zirve-carousel-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Önceki</span>
  </a>

  <!-- Sağ Ok Kontrol -->
  <a class="carousel-control-next zirve-carousel-control-next" href="#zirveCarousel" role="button" data-bs-slide="next">
    <span class="carousel-control-next-icon zirve-carousel-next-icon" aria-hidden="true"></span>

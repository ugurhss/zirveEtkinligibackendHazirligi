...
<div id="zirveCarousel" class="zirve-carousel carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
    <div class="carousel-inner zirve-carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/t2.jpg') }}" alt="İlk Slayt">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/T1.jpg') }}" alt="İkinci Slayt">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100 zirve-carousel-img" src="{{ asset('assets/images/FLAG1.jpg') }}" alt="Üçüncü Slayt">
        </div>
    </div>
</div>
<!-- Carousel Bitiş -->

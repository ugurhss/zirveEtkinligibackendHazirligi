...
<div class="carousel-container">
    <div class="carousel-track" id="carouselTrack">
        <div class="carousel-item">
            <img src="{{ asset('assets/images/speaker1.jpg') }}" alt="Konuşmacı 1">
            <p>Dr. Ayşe Yılmaz</p>
            <span>Akıllı Şehirler ve Dijitalleşme</span>
        </div>
        <div class="carousel-item">
            <img src="{{ asset('assets/images/speaker2.jpg') }}" alt="Konuşmacı 2">
            <p>Mehmet Demir</p>
            <span>Sanayide Dijital Dönüşüm</span>
        </div>
        <div class="carousel-item">
            <img src="{{ asset('assets/images/speaker3.jpg') }}" alt="Konuşmacı 3">
            <p>Zeynep Kaya</p>

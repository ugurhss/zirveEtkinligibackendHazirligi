...
<section class="zirve-banner" style="margin-bottom: -10px;">
        <div class="zirve-content-wrapper">
            ...
            <div class="zirve-aciklama">
                <h3 style="text-align: center; color: white; font-family:'Jura">
                 AMAÇ:
...
<section class="zirve-degerleri">
    <div class="container">
        ...
        <div class="card-container">
            <div class="card">
                <img src="{{ asset('assets/images/genis-katilim.jpg') }}" alt="Teknoloji Odaklı" style="border-radius: 8px;">
            </div>
            <div class="card">
                <img src="{{ asset('assets/images/deger-odakli-yaklasim.jpg') }}" alt="Teknoloji Odaklı" style="border-radius: 8px;">
            </div>
            <div class="card">
                <img src="{{ asset('assets/images/teknoloji-odakli.jpg') }}" alt="Teknoloji Odaklı" style="border-radius: 8px;">
            </div>
            <div class="card">
                <img src="{{ asset('assets/images/yenilikci-bir-bakis-acisi.jpg') }}" alt="Teknoloji Odaklı" style="border-radius: 8px;">
            </div>
        </div>
    </div>
</section>

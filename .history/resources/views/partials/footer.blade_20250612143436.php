...
<section class="footer-section">
    <div class="container">
        ...
        <div class="logo-and-text">
            ...
            <div class="footer-text" style=" margin-left:50px; margin-top: 20px; color: rgb(37, 4, 52); font-size: 24px; font-weight: 600; font-family: 'Jura', sans-serif; text-align: center; padding-bottom: 10px; border-bottom: 2px solid rgba(37, 4, 52, 0.5); margin-right:50px; margin-bottom:20px; width: 300px; height: 100px; display:flex; flex-direction:column; justify-content:center; align-items:center; text-transform: uppercase; text-align:center; line-height:1.2em;"
">
